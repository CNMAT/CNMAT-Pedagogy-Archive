...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 28.5, 289.0, 34.0 ],
					"text" : "Smoothly Variable Delay"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 312.5, 168.5, 65.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.5, 344.5, 82.0, 20.0 ],
					"text" : "loadmess 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 416.5, 156.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 416.5, 96.25, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 416.5, 126.25, 71.0, 20.0 ],
					"text" : "metro 4000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 354.5, 255.75, 56.0, 20.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.5, 186.5, 134.0, 18.0 ],
					"text" : "50, 2000 2000 50 2000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 354.5, 225.75, 56.0, 20.0 ],
					"text" : "line~ 50."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.5, 130.25, 85.0, 20.0 ],
					"text" : "loadmess 300"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.5, 469.0, 100.0, 192.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 85.0, 595.0, 100.0, 192.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 391.5, 281.5, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 53.0, 165.25, 106.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.5, 67.0, 100.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 219.5, 46.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 219.5, 75.0, 50.0, 18.0 ],
					"text" : "loop $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 19.5, 135.75, 256.0, 20.0 ],
					"text" : "selector~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 148.5, 74.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.5, 74.0, 37.0, 18.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 177.5, 108.0, 49.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 98.5, 105.0, 47.0, 20.0 ],
					"text" : "adc~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.5, 38.5, 85.0, 20.0 ],
					"text" : "Input Source"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 374.5, 96.0, 20.0 ],
					"text" : "Feedback (0-1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 96.25, 117.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 335.5, 371.5, 65.0, 24.0 ]
				}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 155.0, 214.0, 19.0, 20.0 ],
													"text" : "0"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 266.0, 214.0, 19.0, 20.0 ],
													"text" : "1"
												}
...
,
					"patching_rect" : [ 309.5, 316.5, 101.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"digest" : "",
						"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 309.5, 405.5, 45.0, 18.0 ],
					"text" : "*~ 0.8"
				}
...
, 			{
				"box" : 				{
					"background" : 1,
					"bgcolor" : [ 0.556673, 1.0, 0.989147, 1.0 ],
					"id" : "obj-4",
					"ignoreclick" : 1,
					"maxclass" : "panel",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 74.0, 275.0, 374.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 319.0, 431.5, 297.5, 431.5, 297.5, 306.5, 319.0, 306.5 ],
					"source" : [ "obj-34", 0 ]
				}
