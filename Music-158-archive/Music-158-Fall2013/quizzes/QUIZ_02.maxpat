...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 483.0, 707.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 660.0, 434.0, 35.0 ],
					"presentation_rect" : [ 485.0, 596.0, 0.0, 0.0 ],
					"text" : "(d) BONUS: create a message to be interpreted by line~ by retrieving data from /fadeInTime, /fadeOutTime, and /maxAmplitude."
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 682.0, 637.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 684.0, 605.0, 80.0, 20.0 ],
					"presentation_rect" : [ 675.0, 657.0, 0.0, 0.0 ],
					"text" : "fadeOutTime"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 506.0, 641.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 608.0, 605.0, 64.0, 20.0 ],
					"presentation_rect" : [ 499.0, 621.0, 0.0, 0.0 ],
					"text" : "frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 756.0, 165.0, 158.0, 62.0 ],
					"presentation_rect" : [ 808.0, 161.0, 0.0, 0.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 29.0, 30.0, 0.0, 0.0 ],
									"text" : "DRAW A SPIRAL",
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 25.0, 320.0, 0.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 752.0, 629.0, 0.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 816.0, 496.0, 0.0, 0.0 ],
									"text" : "3. -8."
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 761.0, 501.0, 0.0, 0.0 ],
									"text" : "1. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 469.5, 750.0, 366.0, 20.0 ],
									"text" : "(This instance is set to have display range -10 to 10 for both axes.)"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 510.0, 416.0, 21.0 ],
					"presentation_rect" : [ 29.0, 393.0, 0.0, 0.0 ],
					"text" : "(c) In words, explain the difference between o.pack and o.pak."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 249.5, 330.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 172.0, 330.0, 50.0, 20.0 ],
					"presentation_rect" : [ 225.0, 329.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 94.0, 330.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 310.0, 69.0, 20.0 ],
					"presentation_rect" : [ 269.0, 333.0, 0.0, 0.0 ],
					"text" : "decay time"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 310.0, 64.0, 20.0 ],
					"presentation_rect" : [ 160.0, 330.0, 0.0, 0.0 ],
					"text" : "amplitude"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.0, 310.0, 64.0, 20.0 ],
					"text" : "frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 256.0, 407.0, 49.0 ],
					"text" : "(b) Gather the input of the following number boxes into an odot bundle (the output of the object you will use should be understood by o.message):"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 353.0, 434.0, 207.0 ],
					"text" : "Create one or more o.expr objects to do the following:\n\n(a) compute the total time by summing appropriate variables for fade-in and fade-out and store it in a new variable;\n(b) compute a new value to be stored in /frequency variable to be twice the value that is currently stored in /frequency.\n\nCreate one or more appropriate odot objects to extract data stored in the odot message above (note: this step may be considered independent of the o.expr questions (a) and (b) above). \n\n(c) You will need to obtain the data from /frequency and from /fadeOutTime varaibles. Connect the object to the following number boxes for verification."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 165.0, 407.0, 35.0 ],
					"text" : "(a) TRUE/FALSE: You may use $-substitution with the o.message object."
				}
