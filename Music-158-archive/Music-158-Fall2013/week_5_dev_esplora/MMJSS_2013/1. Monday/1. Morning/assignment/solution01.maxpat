...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 590.0, 89.0, 20.0 ],
					"text" : "print anything?"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.411743, 600.0, 100.0, 18.0 ],
					"text" : "0.715542 0. 1. 1."
				}
...
, 			{
				"box" : 				{
					"blinkcolor" : [ 1.0, 0.018187, 0.0, 1.0 ],
					"id" : "obj-30",
					"maxclass" : "button",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 190.0, 590.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 710.0, 50.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 823.455872, 276.049011, 145.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 670.0, 270.0, 100.0, 31.0 ],
					"text" : "hsl 0.785924 1. 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 661.5, 152.0, 162.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 710.0, 460.0, 124.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.5, 380.0, 81.0, 20.0 ],
					"text" : "mic loudness"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.411743, 380.0, 39.0, 20.0 ],
					"text" : "slider"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 250.0, 380.0, 99.411743, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 40.588264, 380.0, 54.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 661.5, 460.0, 32.5, 23.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 440.0, 351.176483, 97.549019 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 677.5, 100.0, 115.0, 23.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../../../repositories/git/CNMAT-MMJSS/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../../../repositories/git/CNMAT-odot/abstractions",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
