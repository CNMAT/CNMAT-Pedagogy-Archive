...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 19.5, 550.0, 35.5, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 272.333344, 235.0, 77.0, 25.0 ],
					"text" : "smoother"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 19.0, 335.75, 87.0, 25.0 ],
					"text" : "smoother~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 19.0, 405.75, 44.0, 25.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 19.0, 370.75, 87.0, 25.0 ],
					"text" : "cycle~ 440"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 19.0, 300.75, 49.666668, 25.0 ],
					"text" : "vib~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 265.0, 172.0, 25.0 ],
					"text" : "scale 0. 0.3 200. 3500."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.0, 187.0, 111.0, 25.0 ],
					"text" : "o.route /x /y /z"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "FullPacket" ],
					"patching_rect" : [ 211.0, 187.0, 111.0, 25.0 ],
					"text" : "o.route /x /y /z"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "FullPacket" ],
					"patching_rect" : [ 19.0, 146.0, 131.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 19.0, 105.0, 136.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 69.0, 55.0, 25.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.0, 17.0, 36.0, 36.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 33.0, 109.0, 25.0 ],
					"text" : "o.io.gametrak"
				}
