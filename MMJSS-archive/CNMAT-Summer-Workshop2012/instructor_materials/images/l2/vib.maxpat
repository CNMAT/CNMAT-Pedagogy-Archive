...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 223.571426, 128.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 235.0, 187.571426, 111.0, 25.0 ],
					"text" : "o.route /x /y /z"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 39.0, 331.571442, 44.0, 25.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 39.0, 295.571442, 92.0, 25.0 ],
					"text" : "cycle~ 440."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 39.0, 259.571442, 49.666668, 25.0 ],
					"text" : "vib~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 223.571426, 169.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "FullPacket" ],
					"patching_rect" : [ 39.0, 187.571426, 111.0, 25.0 ],
					"text" : "o.route /x /y /z"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "FullPacket" ],
					"patching_rect" : [ 39.0, 151.571426, 131.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 39.0, 115.571426, 136.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 39.0, 667.0, 40.0, 128.0 ]
				}
